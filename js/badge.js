function injectBadge() {
    ...
    const i = r.attachShadow({
        ...
        p = d ? "div" : "a";
    i.innerHTML = `<div style="position: relative"><${p} class="badge"></${p}><div class="dialog"></div></div><style></style>`;
    {
        ...
        Object.assign(n.style, a), n.innerHTML = '<g style="mix-blend-mode:difference">       <path fill-rule="evenodd" clip-rule="evenodd" d="M13.3276 19.9235C11.8345 19.9235 10.3686 19.3808 9.52704 18.2141L9.23021 19.5901L3.75 22.5L4.34161 19.5901L8.33258 1.5H13.219L11.8074 7.87631C12.9475 6.62818 14.0063 6.16692 15.3636 6.16692C18.2954 6.16692 20.25 8.09338 20.25 11.6207C20.25 15.2566 17.9968 19.9235 13.3276 19.9235ZM15.2007 12.6518C15.2007 14.334 14.0062 15.6093 12.4589 15.6093C11.5902 15.6093 10.8029 15.2837 10.2871 14.7139L11.0473 11.3765C11.6173 10.8067 12.2689 10.4811 13.029 10.4811C14.1963 10.4811 15.2007 11.3494 15.2007 12.6518Z" fill=""/>     </g>', A(e, n);
        const o = l("span");
        o.textContent = "", A(e, o), e instanceof HTMLAnchorElement && (e.href = "", e.target = "_blank", e.style.cursor = "pointer")
    }
    const g = l("style");
    ...
    {
        const e = i.querySelector(".dialog");
        e.innerHTML = `
      ...
      Upgrade to the <a href="https://bolt.new/pricing" target="_blank" style="color: #1488FC; font-weight: bold;">Pro plan</a> to remove it.`;
        ...
        Object.assign(n.style, a), e.appendChild(n);
